...
class HybridSearch:
        ...
        try:
            ...
            async with async_session_factory() as session:
                ...
                query = (
                    ...
                    .where(DocumentChunk.embedding is not None)
                )
        ...
        try:
            async with async_session_factory() as session:
                ...
                query_sql = (
                    ...
                    .join(ReferenceDocument, DocumentChunk.document_id == ReferenceDocument.id)
                    .where(DocumentChunk.level == "child")
                    .where(DocumentChunk.tsv is not None)
    ...
    async def _get_parent_chunk(self, child_chunk_id: int, document_id: int) -> dict | None:
        """
