...
from src.db.models import ValidationRule
...
class ValidationGateway:
    ...
    async def _load_rules(self, discipline: str | None = None) -> list[ValidationRule]:
        """
        ...
        async with async_session_factory() as session:
            query = select(ValidationRule).where(ValidationRule.active)
