...
class OfficeExtractor:
    ...
    def extract(self, file_path: Path, page_count: int | None = None) -> dict:
        """
    ...
    def _extract_docx(self, file_path: Path, page_count: int | None = None) -> dict:
        """
    ...
    def _extract_xlsx(self, file_path: Path, page_count: int | None = None) -> dict:
        """
    ...
    def _extract_pptx(self, file_path: Path, page_count: int | None = None) -> dict:
        """
